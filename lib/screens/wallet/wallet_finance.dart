...
class WalletFinance extends StatefulWidget {
  const WalletFinance({Key? key}) : super(key: key);

  @override
  _WalletFinanceState createState() => _WalletFinanceState();
}

class _WalletFinanceState extends State<WalletFinance> {
